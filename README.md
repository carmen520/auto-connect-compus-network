...
d：在这个HTML代码中，你可以看到元素的ID，比如id="userMessage"。如果你想要通过JavaScript来获取这个元素，你可以使用document.getElementById("userMessage")23。这个方法会返回一个表示ID属性与"userMessage"相匹配的元素的Element对象2
...
1. 修改校园网账号、密码。
2. 测试url_login地址————》校园网登录页面地址
3. 测试url_check地址————》校园网成功登录页面地址
